...
public abstract class Assert {
	...
	public static void isTrue(boolean expression, String key) {
		if (!expression) {
			throw new BusinessException(getMessage(key));
		}
	}
	...
	public static void notNull(Object object, String key, Object... args) {
		if (object == null) {
			throw new BusinessException(getMessage(key + "_IS_NULL", args));
		}
	}
	...
	public static void notEmpty(Object[] array, String key, Object... args) {
		if (ObjectUtils.isEmpty(array)) {
			throw new BusinessException(getMessage(key + "_IS_EMPTY", args));
		}
	}
	...
	public static void isNotBlank(String text, String key) {
		if (StringUtils.isBlank(text)) {
			throw new BusinessException(getMessage(key + "_IS_NULL"));
		}
	}
	...
	public static void min(Integer value, Integer min, String key) {
		notNull(value, key);
		if (value < min) {
			throw new BusinessException(getMessage(key + "_MIN", min));
		}
	}
	...
	public static void max(Integer value, Integer max, String key) {
		notNull(value, key);
		if (value > max) {
			throw new BusinessException(getMessage(key + "_MAX", max));
		}
	}
