...
public class ThreadJacksonMixInHolder {
    ...
    /**
     * 获取线程内的MixIn集合
     * 注意：为了防止线程执行完毕之后仍然存在有数据，请务必适时调用clear()方法
     *
     * @return
     * @see com.aek.common.core.jackson.helper.ThreadJacksonMixInHolder#builderMapper()
     * @see com.aek.common.core.jackson.helper.ThreadJacksonMixInHolder#builderCodehausMapper()
     * @see com.aek.common.core.jackson.helper.ThreadJacksonMixInHolder#clear()
     */
