...
//		gc.setOutputDir("D://");
		...
		dsc.setPassword("root.56");
		dsc.setUrl("jdbc:mysql://192.168.1.57:3306/assets?characterEncoding=utf8");
...
//		strategy.setTablePrefix("sys_");// 此处可以修改为您的表前缀
		...
		// 自定义 service 父类
		 strategy.setSuperServiceClass("com.aek.common.core.base.BaseProvider");
		// 自定义 service 实现类父类
		 strategy.setSuperServiceImplClass("com.aek.common.core.base.BaseProviderImpl");
		// 自定义 controller 父类
